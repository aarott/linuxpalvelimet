...
![image](https://github.com/aarott/linuxpalvelimet/assets/78908566/92bc54eb-b730-4907-914d-7a7f5d2a6a1c)


Ei edelleenkään toimi vaikka kaikki polut conf tiedosto on oikein ja kaikki polut on tarkistettu, aaro.conf on laitettu päälle ja 000-default sivusto pois päältä... Apache2 olen myös käynnistänyt useamman kerran uudestaan.  

Tulen päivittämään tätä tehtävää viimeistään tunnin jälkeen kun saan tähän selvyyttä.  
